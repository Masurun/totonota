class PostsController < ApplicationController
  ...
  def post_params
    params.require(:post).permit(:spa_name, :congestion_rate_id, :visit_time_id, :review, :image, :sauna_temp_id, :water_temp_id,
                                 :pref_id, :chair_count_id).merge(user_id: current_user.id)
  end
